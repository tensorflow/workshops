...
### [Lab 1 - Running a simple pipeline manually in a Colab Notebook](Lab_1_Pipeline_in_Colab.ipynb)
...
### [Lab 2 - Introduction to Apache Beam](Lab_2_Intro_to_Apache_Beam.ipynb)
...
### [Lab 3 - Using the Apache Beam Orchestrator for TFX](Lab_3_Beam_Orchestrator.ipynb)
...
### [Lab 4 - TensorFlow Data Validation](Lab_4_Data_Validation.ipynb)
...
### [Lab 5 – Preprocessing data with TensorFlow Transform](Lab_5_TensorFlow_Transform.ipynb)
